    ...
    return (
        <body class="min-h-screen hidden lg:block">
            ...
            <div class="w-80 px-2 min-h-screen flex flex-col py-2">
                <div class="group">
                    <div class=" mt-1">
                        <div href="/" class="hover:bg-gray-200 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                ...
                <div class="group flex-1">
                    ...
                    <div class="m-2">
                        ...
                        </div><div href="/" class="hover:bg-gray-200 px-2.5 py-1.5 flex items-center space-x-3 rounded-md">
                            <div class="w-10 h-10 rounded-lg overflow-hidden">
                                <img class="w-full" src="https://scontent.fdac157-1.fna.fbcdn.net/v/t39.30808-6/240355291_906587126873428_627206812571233428_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=5f2048&_nc_ohc=bWnorf9FkdEAX9-wrHk&_nc_ht=scontent.fdac157-1.fna&oh=00_AfAQQrV7ZdqSBGjOYEh4BLnaDSK2xR_TVwpyH-dziOOzJA&oe=655D0541" alt="Appifylab" />
                            </div>
                            <div class="flex flex-col justify-center content-start">
                ...
                <div class="text-gray-500 text-xs space-x-2">
                    <span href="/" class="hover:underline">Privacy</span>
                    <span href="/" class="hover:underline">Terms</span>
                    <span href="/" class="hover:underline">Advertising</span>
                    <span href="/" class="hover:underline">Ad Choices</span>
                    <span href="/" class="hover:underline">Cookies</span>
                    <span href="/" class="hover:underline">More</span>
